...
#alternativas como filas y estados como columnas
#columnas las llama e1, e2, e3 y a las filas d1, d2, d3
...
#which indica la posicion en laq se encuentra el min o el max o incluso empates
...
#le paso la tabla y se mete en uno o en otro segun sea favorable o desfavorable
...
#creamos una lista para que R me devuelva mas de una cosa
